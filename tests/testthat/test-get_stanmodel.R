test_that("get ensemble model works", {
  ...
  expect_equal(get_mcmc_ensemble_model(priors_hier)@model_name, "ensemble_model_hierarchical_explicit")
  ...
  expect_equal(get_mcmc_ensemble_model(priors_lkj)@model_name, "ensemble_model_explicit")
  ...
  expect_equal(get_mcmc_ensemble_model(priors_hier, drivers = TRUE)@model_name, "ensemble_model_hierarchical_withdrivers_explicit")
  ...
  expect_equal(get_mcmc_ensemble_model(priors_lkj, drivers = TRUE)@model_name, "ensemble_model_withdrivers_explicit")
